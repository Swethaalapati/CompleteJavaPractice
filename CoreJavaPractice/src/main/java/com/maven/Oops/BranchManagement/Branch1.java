...
public class Branch1 {
	...
	public Branch1(int id, String branchName, String branchHead, ArrayList<String> subjects) {
	...
	public String toString() {
		return "Branch1 [id=" + id + ", branchName=" + branchName + ", branchHead=" + branchHead + ", subjects="
				+ subjects + "]";
	}
